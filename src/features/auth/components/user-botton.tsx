  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger className="outline-none relative">
        <Avatar className="size-10 hover: opacity-50 transition border border-neutral-300">
          <AvatarFallback className="bg-neutral-200 font-medium to-neutral-50 flex items-center justify-center">
            {avatarFallback}
          </AvatarFallback>
        </Avatar>
      </DropdownMenuTrigger>
      ...
      >
        <div className="flex flex-col items-center justify-center gap-2 px-2.5">
          <Avatar className="size-[52px] transition border border-neutral-300">
            <AvatarFallback className="bg-neutral-200 text-xl font-medium to-neutral-50 flex items-center justify-center">
              {avatarFallback}
            </AvatarFallback>
          </Avatar>
